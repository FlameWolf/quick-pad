				...
				command === "build"
					? [
							purgeCSSPlugin({
								...
								safelist: {
									standard: [/^btn-(outline-)?(primary|secondary|success|danger|warning|info|light|dark|link)$/, /^alert-(primary|secondary|success|danger|warning|info|light|dark)$/, /^bg-(black|silver|gray|white|maroon|red|purple|fuchsia|green|lime|olive|yellow|navy|blue|teal|aqua)$/, "d-hidden"]
								}
							})
						]
					: []
