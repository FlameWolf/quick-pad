...
<template>
		...
		<div class="container gap-2">
			...
			<div class="d-flex align-items-center gap-2">
				...
				<button class="btn btn-secondary btn-sm" @click="toggleTheme">
					...
					<svg v-else xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-sun-fill" viewBox="0 0 16 16">
	...
	<footer class="bg-body-tertiary border-top mt-4">
		<div class="container px-2 py-3 d-flex flex-wrap justify-content-center align-items-center gap-3 small text-muted">
			...
			<a class="icon-link link-secondary text-decoration-none" onclick="window.open(`https://github.com/FlameWolf/quick-pad`)" role="button">
