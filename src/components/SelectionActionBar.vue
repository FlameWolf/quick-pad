<script setup lang="ts">
	...
	const emit = defineEmits<{
		action: [key: SelectionAction["key"]];
		cancel: [];
	}>();
...
<template>
	<div class="selection-action-bar">
		...
		<div class="d-flex gap-2 flex-wrap justify-content-end w-100">
			<button v-if="props.showColours" ref="dropup-trigger" class="btn btn-sm btn-outline-primary dropdown-toggle" @click="dropdown.toggle()">Apply Colour</button>
