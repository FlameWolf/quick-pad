...
<template>
	...
	<template v-else>
		...
		<DisplayTagList class="mb-3" :active-tags="Array.from(notesStore.searchTags.value)" :allow-create="isSelecting" :allow-delete="true" :allow-edit="true" :allow-manage="!isSelecting" @selection-changed="updateTagFilter"/>
