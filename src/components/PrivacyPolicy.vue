	...
	const sections: LegalSection[] = [
		...
		},
		{
			...
			blocks: [
				...
				{
					type: "list",
					items: ["Google — if you sign in and sync, your notes and your Google account name and email are processed and stored on Google's servers. Google's handling of this data is governed by Google's own privacy policy (<a href=\"https://policies.google.com/privacy\">https://policies.google.com/privacy</a>) and terms (<a href=\"https://policies.google.com/terms\">https://policies.google.com/terms</a>). We encourage you to review them to understand how Google processes the data you sync.", "Vercel — QuickPad is hosted on Vercel as a single project comprising the static app plus the serverless functions in /api/auth. When your browser requests the page or calls those auth functions (sign-in, token refresh, sign-out), Vercel necessarily receives the request and, like most hosting platforms, may record standard server request logs that can include your IP address, user agent, and timestamps. QuickPad does not add its own analytics or logging on top of this. Vercel's data practices are described in Vercel's privacy policy (<a href=\"https://vercel.com/legal/privacy-policy\">https://vercel.com/legal/privacy-policy</a>)."]
				},
